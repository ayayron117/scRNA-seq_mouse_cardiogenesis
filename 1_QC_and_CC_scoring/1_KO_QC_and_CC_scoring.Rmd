---
title: "KO Quality Control and Cell Cycle Scoring"
...
```{r, KO-unfilt-scatter, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "KO_QC/KO_QC_images/0_KO_unfiltered_scatter_plots"
...
```{r, KO-unfilt-vln, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "KO_QC/KO_QC_images/0_KO_unfiltered_vln_plots"
...
```{r, KO-unfilt-umap, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "KO_QC/KO_QC_images/0_KO_unfiltered_UMAPs"
...
```{r, KO-dbl-scatter, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "KO_QC/KO_QC_images/1_KO_doublet_scatter_plots"
...
```{r, KO-dbl-vln, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "KO_QC/KO_QC_images/1_KO_doublet_vln_plots"
...
```{r, KO-dbl-vln-clusters, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "KO_QC/KO_QC_images/1_KO_vln_scdblfinder_clusters"
...
```{r, KO-orig-vln-clusters, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "KO_QC/KO_QC_images/1_KO_vln_original_clusters"
...
```{r, KO-dbl-umap, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "KO_QC/KO_QC_images/1_KO_doublet_UMAPs"
...
```{r, KO-filt-scatter, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "KO_QC/KO_QC_images/2_KO_scatter_plots"
...
```{r, KO-filt-vln, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "KO_QC/KO_QC_images/2_KO_vln_plots"
...
```{r, KO-filt-vln-clusters, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "KO_QC/KO_QC_images/2_KO_vln_final_clusters"
...
```{r, KO-filt-umap, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "KO_QC/KO_QC_images/2_KO_UMAPs"
