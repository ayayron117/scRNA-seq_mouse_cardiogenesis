...
```{r, WT-unfilt-scatter, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "WT_QC/WT_QC_images/0_WT_unfiltered_scatter_plots"
...
```{r, WT-unfilt-vln, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "WT_QC/WT_QC_images/0_WT_unfiltered_vln_plots"
...
```{r, WT-unfilt-umap, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "WT_QC/WT_QC_images/0_WT_unfiltered_UMAPs"
...
```{r, WT-dbl-scatter, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "WT_QC/WT_QC_images/1_WT_doublet_scatter_plots"
...
```{r, WT-dbl-vln, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "WT_QC/WT_QC_images/1_WT_doublet_vln_plots"
...
```{r, WT-dbl-vln-clusters, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "WT_QC/WT_QC_images/1_WT_vln_scdblfinder_clusters"
...
```{r, WT-orig-vln-clusters, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "WT_QC/WT_QC_images/1_WT_vln_original_clusters"
...
```{r, WT-dbl-umap, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "WT_QC/WT_QC_images/1_WT_doublet_UMAPs"
...
```{r, WT-filt-scatter, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "WT_QC/WT_QC_images/2_WT_scatter_plots"
...
```{r, WT-filt-vln, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "WT_QC/WT_QC_images/2_WT_vln_plots"
...
```{r, WT-filt-vln-clusters, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "WT_QC/WT_QC_images/2_WT_vln_final_clusters"
...
```{r, WT-filt-umap, echo = FALSE, message=FALSE, eval=TRUE, out.height='70%', out.width='70%'}

plot_paths <- "WT_QC/WT_QC_images/2_WT_UMAPs"
