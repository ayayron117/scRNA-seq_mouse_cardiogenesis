...
plot_paths <- dir(plot_path, full.names = TRUE)

```

```{r, image-ref-for-in-text, echo = TRUE, message=FALSE, fig.align='center', out.width='500\\linewidth', out.height='500\\linewidth', fig.pos='H'}
