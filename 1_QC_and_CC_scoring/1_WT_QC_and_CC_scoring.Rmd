...
```{r, WT-unfilt-scatter, echo = FALSE, message=FALSE, eval=TRUE}
...
```{r, WT-unfilt-vln, echo = FALSE, message=FALSE, eval=TRUE}
...
```{r, WT-dbl-scatter, echo = FALSE, message=FALSE, eval=TRUE}
...
```{r, WT-dbl-vln, echo = FALSE, message=FALSE, eval=TRUE}
...
```{r, WT-dbl-vln-clusters, echo = FALSE, message=FALSE, eval=TRUE}
...
```{r, WT-orig-vln-clusters, echo = FALSE, message=FALSE, eval=TRUE}
...
```{r, WT-dbl-umap, echo = FALSE, message=FALSE, eval=TRUE}
...
```{r, WT-filt-scatter, echo = FALSE, message=FALSE, eval=TRUE}
...
```{r, WT-filt-vln, echo = FALSE, message=FALSE, eval=TRUE}
...
```{r, WT-filt-vln-clusters, echo = FALSE, message=FALSE, eval=TRUE}
...
```{r, WT-filt-orig-clusters, echo = FALSE, message=FALSE, eval=TRUE}

plot_paths <- "WT_QC/WT_QC_images/2_WT_vln_original_clusters"
...
```{r, WT-filt-umap, echo = FALSE, message=FALSE, eval=TRUE}
